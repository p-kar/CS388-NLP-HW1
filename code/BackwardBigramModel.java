...
/**
 * @author Pratyush Kar
 * A backward bigram language model that models the generation of sentences
 * from right to left.
 */
...
public class BackwardBigramModel {
    ...
    public void trainSentence(List<String> sentence) {
        // First count an initial end sentence token
        String prevToken = "</S>";
    ...
    /**
     * Like test1 but excludes predicting start-of-sentence when computing perplexity
     */
    ...
    /**
     * Like sentenceLogProb but excludes predicting start-of-sentence when computing prob
     */
